...
| `packages/cli` | the `canonweave` binary: init/build/check/gate/fingerprint/clear/reconcile/sync-issues/serve/selftest |
...
| `docs/` | [quickstart](docs/quickstart.md) · [file formats](docs/file-format.md) · [gate profiles](docs/gate-profiles.md) · [reconcile loop](docs/reconcile.md) · [issues/board projection](docs/sync-issues.md) · [dashboard](docs/serve.md) · [security](docs/security.md) |
